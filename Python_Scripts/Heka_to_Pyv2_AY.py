...
#Allows the user to identify which Cell, Experiment, and Trace they would like to analyze    
print('There are ' + str(int(mat['CellNum'])) + ' cells in the files.')
if mat['CellNum'] == 1:
    print('Cell #1 has ' + str(int(mat['C1Expts'])) + ' traces.')
if mat['CellNum'] == 2:
    print('Cell #1 has ' + str(int(mat['C1Expts'])) + ' traces.')
    print('Cell #2 has ' + str(int(mat['C2Expts'])) + ' traces.')
if mat['CellNum'] == 3:
    print('Cell #1 has ' + str(int(mat['C1Expts'])) + ' traces.')
    print('Cell #2 has ' + str(int(mat['C2Expts'])) + ' traces.')
    print('Cell #3 has ' + str(int(mat['C3Expts'])) + ' traces.')
CellVal = int(input(' Which cell would youl like to analyze? :'))
ExptVal = int(input('Which experiment would you like to analyze? :')) - 1 #1 is subtracted due to Python starting at 0
TraceVal = int(input('Which trace would you like to analyze? (Input the number of the trace "1-11" or input "12" for all traces) :')) - 1 #1 is subtracted due to Python starting at 0
    ...
    if TraceVal <= 11:    
        ...
        for i in Cell1[ExptVal][TraceVal]:
            ...
            if traces_results[0]['Spikecount'] == 1:
                ...
                print('Trace ' + str(TraceVal + 1) + ' of Cell ' + str(CellVal) + ' analyzed successfully!')
                break
