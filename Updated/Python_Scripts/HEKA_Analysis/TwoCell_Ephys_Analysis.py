...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#Calculates IV curve parameters FOR TWO CELLS including spikecount, RMP, Rin, Freq, etc.
elif cells == 2:
    for ii in range(cells):
        if 'IV' in Cell['ExptID']:
            User_choices['IV_graph' + str(ii + 1)] = int(input('Would you like to save the graph? (Input 1 if yes): '))
            User_choices['IV_output' + str(ii + 1)] = int(input('Would you like to output the results as a CSV? (Input 1 if yes): '))
            
            x = 0
            for i in Cell['C'+ str(ii + 1) + 'Data'][x:Cell['TraceMax'][1]:1]:
                trace1 = {}
                trace1['T'] = Cell['Time'][:]
                trace1['V'] = Cell['C' + str(ii + 1) + 'Data'][:,x]
                trace1['stim_start'] = [201]
                trace1['stim_end'] = [700]
                traces = [trace1]
                traces_results = efel.getFeatureValues(traces,['Spikecount','voltage_base','peak_voltage','peak_time'])
                ...
                if traces_results[0]['Spikecount'] == 1:
                    #Calculate input resistance based on lowest hyperpolarizing step (Hard coded hyperpolarizing step)
                    trace_calc['Vin'] = (((Cell['C' + str(ii + 1) + 'Data'][6000,5]) - (Cell['C' + str(ii + 1) + 'Data'][2000,5])) / 1000) #Voltage is calculated in mV, but converted to V
                    trace_calc['Iin'] = (((Cell['Stim'][6000,5]) - (Cell['Stim'][2000,5])) / 1000000) #Current is calculated in microA, but converted to A
                    trace_calc['Rin'] = ((trace_calc['Vin']/trace_calc['Iin']) / 1000) #Resistance is provided in MOhms
                    trace_calc['Rheo'] = ((Cell['Stim'][4001,x])*1000)+1
                    Trace_Results = {'AP #': int(traces_results[0]['Spikecount']), 'RMP': float(traces_results[0]['voltage_base']),
                    ...
                    #Plot individual traces with one spike
                    plt.plot(Cell['Time'],Cell['C' + str(ii + 1) + 'Data'][:,x])
                    plt.title('Cell ' + str(User_choices['CellVal']) + ', Trace ' + str(x))
                    plt.scatter(traces_results[0]['peak_time'],traces_results[0]['peak_voltage'] + 20,c='r',marker = '+')
                    plt.xlabel('Time (in ms)')
                    plt.ylabel('Voltage (in mV)')
            ...
            plt.plot(Cell['Time'],Cell['C' + str(ii + 1) + 'Data'])
            plt.title('All Traces')
            plt.xlabel('Time (in ms)')
            plt.ylabel('Voltage (in mV)')
            if User_choices['IV_graph' + str(ii + 1)] == 1:
                #Change the string here to modify the output graph name
                plt.savefig('IV.svg',format='svg',dpi = 1200)
            plt.show()
        
            #Outputs IV parameters into a CSV
            if User_choices['IV_output' + str(ii + 1)] == 1:
                with open(str(AllData['filename']) + '_IV.csv','w') as IV:
                    writer1 = DictWriter(IV,('AP #','RMP','Rin','Rheobase','Duration_of_Spiking',
                                         'Mean_Half-Height_Width','Mean_AP_Amplitude',
                                         'Mean_Inst_Freq','Max_Freq','Freq_Adapt','Peak_Adapt',
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#Used to calculate single pulse parameters (all sweeps) of ONE CELL
if cells == 0:
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#Used to calculate single pulse parameters (all sweeps) of TWO CELLS
if cells == 2:
    for ii in range(cells):
        if 'SP CC' in Cell['ExptID']:
            #Allows the user to save the average graph, if needed
            User_choices['SPCCGraph' + str(ii + 1)] = input('Would you like to save the average/individual trace graph? (Input "Yes" or "No"): ')
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#Calculates the PPR Ratio of pulses 2-5 compared to the amplitude of pulse 1 for ONE CELL
if cells == 0:
    if 'PPR CC' in Cell['ExptID']:
        ...
        output.close()
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#Calculates the PPR Ratio of pulses 2-5 compared to the amplitude of pulse 1 for TWO CELLS
if cells == 2:
    for ii in range(cells):
        if 'PPR CC' in Cell['ExptID']:
            #Allows the user to save the average graph, if needed
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#Calculates average PSP for each of the 25 pulses for ONE CELL
if cells == 0:
    if 'Train CC' in Cell['ExptID']:
        ...
        with open(str(AllData['filename']) + 'Train_IndividualTraces_' + str(User_choices['CellVal']) + '.txt', 'w') as Train:
            ...
            Train.close()
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#Calculates average PSP for each of the 25 pulses for TWO CELLS
if cells == 2:
    for ii in range(cells):
            if 'Train CC' in Cell['ExptID']:
                #Allows the user to save the average graph, if needed
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#                                  Analysis Section--SP E/I Balance Analysis
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#Calculates the average PSP amplitude due to SP when bath contains 50 micromolar bicuculline external for ONE CELL
if cells == 0:
    if 'SP E/I' in Cell['ExptID']:
        #Same NaNing method as SP
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#Calculates the average PSP amplitude due to SP when bath contains 50 micromolar bicuculline external for TWO CELLS
if cells == 2:
    for ii in range(cells):
            if 'SP E/I' in Cell['ExptID']:
                #Same NaNing method as SP
