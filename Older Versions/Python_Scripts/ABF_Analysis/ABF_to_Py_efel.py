...
for i in SortedData[IterVar:TraceNum:1]:
    ...
    traces_results = efel.getFeatureValues(traces,[
                                            ...
                                            'ISI_values','spike_width2','time_to_first_spike','peak_indices'])
    ...
    #Appends each trace dictionary into a list
    AllAverages.append(averages)
                
    #Iterates through each trace by changing the value of the iterable variable once the loop has been completed
    IterVar += 1
